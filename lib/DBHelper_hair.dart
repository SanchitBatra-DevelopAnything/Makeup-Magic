...
class DBHelper_Hair{
  ...
  static const String TABLE = 'hairTable';
  ...
  static const String DB_NAME = 'photos_hair.db';
  ...
  Future<dynamic> clearDataOfHair() async{
  ...
  Future<Photo> saveInHair(Photo photo) async{
    var dbClient = await db;
    try{ photo.id =  await dbClient.insert(TABLE, photo.toMap());} catch(error){
  ...
  Future<List<Photo>> getPhotosOfHair() async{
    var dbClient = await db;
