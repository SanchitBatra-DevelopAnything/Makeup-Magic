...
class DBHelper_Party{

  static Database _db;
  static const String ID = 'id';
  static const String NAME = 'photoName';
  static const String TABLE = 'partyTable';
  ...
  static const String DB_NAME = 'photos_party.db';
  ...
  Future<dynamic> clearDataOfParty() async{
  ...
  Future<Photo> saveInParty(Photo photo) async{
    var dbClient = await db;
  ...
  Future<List<Photo>> getPhotosOfParty() async{
    var dbClient = await db;
